...
/obj/structure/closet/crate/secure/chem
	desc = "A crate containing various supplies for the preperation of chemicals.  It appears to have an electronic lock on it.."
	name = "Chemical Preparations Crate"
	icon = 'icons/obj/storage.dmi'
	icon_state = "medicalcrate"
	density = 1
	icon_opened = "medicalcrateopen"
