/datum/job/hos
	...
	equip(var/mob/living/carbon/human/H)
		...
		if(H.backbag == 1)
			...
			H.equip_to_slot_or_del(new /obj/item/clothing/mask/gas(H), slot_in_backpack)
...
/datum/job/SParamedic
	...
	supervisors = "the head of security"
	selection_color = "#ffeeee"
	access = list(access_security, access_sec_doors, access_brig, access_court, access_medical, access_morgue, access_surgery)
	minimal_access = list(access_security, access_sec_doors, access_brig, access_court, access_medical, access_morgue, access_surgery)

	equip(var/mob/living/carbon/human/H)
		if(!H)	return 0
		H.equip_to_slot_or_del(new /obj/item/device/radio/headset/headset_paramedic(H), slot_ears)
		...
		H.equip_to_slot_or_del(new /obj/item/clothing/under/rank/paramedic(H), slot_w_uniform)
		H.equip_to_slot_or_del(new /obj/item/clothing/shoes/jackboots(H), slot_shoes)
		H.equip_to_slot_or_del(new /obj/item/device/pda/medical(H), slot_belt)
		H.equip_to_slot_or_del(new /obj/item/clothing/suit/storage/labcoat/armored(H), slot_wear_suit)
//		H.equip_to_slot_or_del(new /obj/item/clothing/head/helmet/parahelmet(H), slot_in_backpack)
		H.equip_to_slot_or_del(new /obj/item/clothing/gloves/black(H), slot_gloves)
		H.equip_to_slot_or_del(new /obj/item/clothing/glasses/sunglasses/sechud(H), slot_glasses)
		H.equip_to_slot_or_del(new /obj/item/device/flash(H), slot_l_store)
