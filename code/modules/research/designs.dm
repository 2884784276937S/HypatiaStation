...
datum/design/news
	name = "Circuit Design (Newscaster)"
	desc = "Allows for the construction of circuit boards used to construct newscasters."
	id = "newscaster"
	build_type = IMPRINTER
	materials = list("$glass" = 2000, "sacid" = 20)
	build_path = "/obj/item/weapon/circuitboard/news"
