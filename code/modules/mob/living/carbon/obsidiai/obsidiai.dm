...
/mob/living/carbon/rock/obsidiai/Stat()
	..()
	statpanel("Status")
	stat("This mob is currently unfinished.  This currently exists for debug-purposes only.  Playing this mob is not advised.")
...
/*
/mob/living/carbon/rock/obsidiai/attack_slime(var/slime as mob) //Obsidiai need their own attack_slime proc. //BROKEN PIECE OF ****
	var/mob/living/carbon/slime/M = slime
	if(M.Victim) return // can't attack while eating!

	for(var/mob/O in viewers(src, null))
		if ((O.client && !( O.blinded )))
			O << "\red <B>The [M.name] attempts to glomp \the[src.name], however this has no effect on their obsidian skin!</B>"
