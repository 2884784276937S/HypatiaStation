/obj/effect/equip_e/rock/obsidiai/process()
	if (item)
...
/obj/effect/equip_e/rock/obsidiai/done()
...
/mob/living/carbon/rock/obsidiai/equip_to_slot(obj/item/W as obj, slot, redraw_mob = 1)
	if(!slot) return
	if(!istype(W)) return
