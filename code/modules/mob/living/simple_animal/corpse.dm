...
/obj/effect/landmark/mobcorpse/orionblades
	name = "Orion Blades Shocktrooper"
	corpseuniform = /obj/item/clothing/under/syndicate
	corpsesuit = /obj/item/clothing/suit/space/syndicate/black/orange
	corpseshoes = /obj/item/clothing/shoes/swat
	corpsegloves = /obj/item/clothing/gloves/swat
	corpseradio = /obj/item/device/radio/headset
	corpsemask = /obj/item/clothing/mask/gas/
	corpsehelmet = /obj/item/clothing/head/helmet/space/syndicate/black/orange
	corpseback = /obj/item/weapon/tank/jetpack/oxygen
	corpsepocket1 = /obj/item/weapon/tank/emergency_oxygen
	corpseid = 1
	corpseidjob = "Shocktrooper"
	corpseidaccess = "Syndicate"