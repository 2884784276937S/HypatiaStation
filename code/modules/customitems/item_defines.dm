...
/obj/item/fluff/mechpermit/attack_self(mob/user as mob)
	for(var/mob/O in viewers(user, null))
		O.show_message(text("[] shows you: \icon[] []: assigned to: [].  You feel your brain melting, just glancing at the legal jargon.", user, src, src.name, src.hname), 1)
