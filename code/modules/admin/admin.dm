...
/datum/admins/proc/Secrets()
	...
	if(check_rights(R_FUN,0))
		dat += {"
			...
			<A href='?src=\ref[src];secretsfun=syndi_striketeam'>Send in a syndacite strike team</A><BR>
...
/datum/admins/proc/adjump()
	...
	log_admin("[key_name(usr)] Toggled admin jumping to [config.allow_admin_jump].")
...
/datum/admins/proc/adspawn()
	...
	log_admin("[key_name(usr)] Toggled admin item spawning to [config.allow_admin_spawning].")
...
/datum/admins/proc/adrev()
	...
	message_admins("\blue [key_name(usr)] toggled reviving to [config.allow_admin_rev].")
	log_admin("[key_name(usr)] Toggled reviving to [config.allow_admin_rev].")
...
/client/proc/cmd_mob_weaken(var/mob/living/carbon/human/M in mob_list)
	set category = "Admin"
	set name = "Weaken"
...
/client/proc/cmd_mob_unweaken(var/mob/living/carbon/human/M in mob_list)
	set category = "Admin"
	set name = "Unweaken"
