...
//	"Protip: Roros like being contained by their shields! Use them. Also, remember to feed them.",
	...
	"Protip: When OOC is disabled, you can't go (OOC) over the radio, because we now have a way to filter it.",
	...
	"Protip: Flavor texts can usually give interesting examinations, look at them, and more importantly, have them.",
