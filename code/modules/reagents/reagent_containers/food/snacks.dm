...
/obj/item/weapon/reagent_containers/food/snacks/meatpizzaslice
	...
	desc = "A slice of triple-meat pizza, with extra grease"
	icon_state = "meatpizzaslice"
	bitesize = 2

/obj/item/weapon/reagent_containers/food/snacks/sliceable/pizza/pizzahawaiian
	name = "Hawaiian pizza"
	desc = "It has pineapple in it. Brought to you by Samuel Axe"
	icon_state = "pizzahawaiian"
	slice_path = /obj/item/weapon/reagent_containers/food/snacks/pizzahawaiianslice
	slices_num = 6
	New()
		..()
...
/obj/item/weapon/reagent_containers/food/snacks/pizzahawaiianslice
	name = "Hawaiian pizza slice"
	desc = "A slice of Hawaiian pizza, with pineapple."
