...
var/secret_force_mode = "extended" // if this is anything but "secret", the secret rotation will forceably choose this mode
...
#define INFINITY 1e31 //closer then enough
	...
	//We're a roleplay server, we actually use things like this.  I'm sure we can trust the majority of players won't abuse this --Numbers
#define MAX_MESSAGE_LEN 2048
#define MAX_PAPER_MESSAGE_LEN 8192
#define MAX_BOOK_MESSAGE_LEN 32726
